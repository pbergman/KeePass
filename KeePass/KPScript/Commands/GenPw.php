    ...
    public function setProfile($profile)
    {
        if (is_numeric($profile)) {
            ...
            if (isset($this->profiles[$profile])) {
                ...
                throw new \KeePass\Exceptions\OptionNotAllowedException($profile, array_keys($this->profiles));
            }

        } else {

            if (!in_array($profile, $this->profiles)) {
                throw new \KeePass\Exceptions\OptionNotAllowedException($profile, $this->profiles);
            }
