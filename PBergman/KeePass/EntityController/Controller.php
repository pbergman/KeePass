 ...
 */
namespace PBergman\KeePass\EntityController;

use PBergman\SharedMemory\Controller as SHMController;
...
class Controller
{
     ...
     */
    public function setApplication(\PBergman\KeePass\Application $application)
    {
        $this->application = $application;
    }

    /**
     * @return \PBergman\KeePass\Application
     */
    ...
    public function saveEntity($entity)
    {
        ...
        if ( false !== $reflection->isSubclassOf('PBergman\KeePass\Entity\BaseEntity') ) {
